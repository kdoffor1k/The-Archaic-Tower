...
public class GestureHandle : MonoBehaviour {
    ...
    readonly AirSigManager.Mode[] availableMode = {
        ...
        // DeveloperDefined: Received gesture that's custom defined in the gesture profile
        // plugin
        ...
        // IdentifyPlayerSignature: Received gesture will be verified against trained data in Mode.Train
        AirSigManager.Mode.IdentifyPlayerSignature,

        // AddPlayerGesture: Received gesture will be used to train as gesture level accuracy
    ...
    readonly string DEFAULT_INSTRUCTION_TEXT = "Pressing trigger and write in the air\nReleasing trigger when finish";
